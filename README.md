# In my demo:
- Enemies spawn on a 50x50 white platform at a default rate of 1 per second until a default maximum of 20
- There is gui to change the spawn rate, change the maximum, and kill all
